...
[](https://www.google.com/search?q=https://github.com/NezrKaan/steam_tracker/graphs/commit-activity)
[](https://nezrkaan.com)
...
```
  ...
  * **api\_key**: Obtain from [Steam Developer Portal](https://steamcommunity.com/dev/apikey).
  * **webhook\_url**: (Optional) For Discord notifications.
  * **target\_users**: List of SteamID64s to monitor.
...
1.  **Initialization**: Validates API credentials and resolves target vanity URLs.
2.  **Baseline Acquisition**: Fetches initial state for all targets.
3.  **Polling Loop**: Queries the Steam API at defined intervals.
4.  **Delta Analysis**: Compares current state against cached state to identify changes.
5.  **Reporting**: Logs events to console/disk and dispatches webhook alerts.
...
**NezrKaan**
**Website:** [nezrkaan.com](https://nezrkaan.com)
**GitHub:** [github.com/NezrKaan](https://www.google.com/search?q=https://github.com/NezrKaan)
